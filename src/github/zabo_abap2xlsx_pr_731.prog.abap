...
CLASS ltc_main DEFINITION
  ...
  PRIVATE SECTION.
    ...
    METHODS get_count
      IMPORTING
        iterator      TYPE REF TO cl_object_collection_iterator
      RETURNING
        VALUE(result) TYPE i.
    ...
    DATA: lo_excel         TYPE REF TO zcl_excel,
          ...
          columns_iterator TYPE REF TO cl_object_collection_iterator,
          rows_iterator    TYPE REF TO cl_object_collection_iterator,
